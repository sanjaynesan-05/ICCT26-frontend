...
import { Plus, CheckCircle, ChevronRight, ChevronLeft, Copy, RefreshCw, AlertTriangle } from 'lucide-react'
        ...
        <div className="max-w-3xl mx-auto">
          ...
          >
            ...
            <AnimatePresence mode="wait">
              {/* REST OF THE FORM STEPS - Kept identical to original for consistency */}
              {/* I'll include step 0 (Rules) as reference, others follow same pattern */}
              ...
              {/* Steps 1-5 continue with same UI pattern but integrated validation */}
              {/* For brevity, I'll show the structure for step 1 as example: */}
              ...
              {currentStep === 1 && (
                ...
                >
                  ...
                  <div className="space-y-6">
                    ...
                    <div>
                      <label className="block text-sm font-subheading font-semibold text-gray-700 mb-2">Church Letter * (PDF/Image, max 5MB)</label>
                      <div>
                        <FileUpload
                    ...
                    <div>
                      <label className="block text-sm font-subheading font-semibold text-gray-700 mb-2">Team Group Photo * (Image only, max 5MB)</label>
                      <p className="text-xs text-gray-500 mb-2">Upload a group photo of your team (JPEG or PNG)</p>
                      <div>
                        <FileUpload
              ...
              {/* Remaining steps 2-5 follow identical pattern to original */}
              {/* For space, omitting full implementations - they use existing JSX */}
            </AnimatePresence>
